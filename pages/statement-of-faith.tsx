...
const TextSection = () => (
  <ContainerSmall className="space-y-4 pt-12 pb-20">
    <p>
      ...
      <em>
        &ldquo;All Scripture is given by inspiration of God, and is profitable
    ...
    <p>
      ...
      <em>
        &ldquo;Which also said, Ye men of Galilee, why stand ye gazing up into
        heaven? this same Jesus, which is taken up from you into heaven, shall
        so come in like manner as ye have seen him go into heaven.&rdquo;
      </em>{' '}
      Acts 1:11; also see John 10:33, Matthew 1:23, Hebrews 4:15, John 2:11, 1
      Corinthians 15:3, John 11:25, and Mark 16:19)
    </p>
    <p>
    ...
    <p>
      ...
      <em>
        &ldquo;Marvel not at this: for the hour is coming, in the which all that
        are in the graves shall hear his voice, And shall come forth; they that
        have done good, unto the resurrection of life; and they that have done
        evil, unto the resurrection of damnation.&rdquo;
      </em>{' '}
      – John 5:28-29)
    </p>
    <p>
      ...
      Lord Jesus Christ. (
      <em>
        &ldquo;There is one body, and one Spirit, even as ye are called in one
        hope of your calling; One Lord, one faith, one baptism, One God and
        Father of all, who is above all, and through all, and in you all.&rdquo;
      </em>{' '}
      – Ephesians 4:4-6)
    </p>
    <p>
      ...
      <em>
        &ldquo;For whom he did foreknow, he also did predestinate to be
        conformed to the image of his Son, that he might be the firstborn among
        many brethren.&rdquo;
      </em>{' '}
      – Romans 8:29) We believe that the sign gifts (prophecy, healing, and
      tongues) ceased when the canon of Scripture was complete (1 Corinthians
      13:8-10).
    </p>
    <p>
